<nav class="navbar navbar-expand navbar-light navbar-bg" style="padding: 0.7rem">
            ...
            <li class="nav-item dropdown">
                ...
                <div class="dropdown-menu dropdown-menu-end" aria-labelledby="languageDropdown">
                    <a class="dropdown-item" href="#">
                        <img src="{{ asset('assets/img/flags/us.png')}}" alt="English" width="20" class="align-middle me-1" />
                        <span class="align-middle">English</span>
                    </a>
                    <a class="dropdown-item" href="#">
                        <img src="{{ asset('assets/img/flags/es.png')}}" alt="Spanish" width="20" class="align-middle me-1" />
                        <span class="align-middle">Spanish</span>
                    </a>
                    <a class="dropdown-item" href="#">
                        <img src="{{ asset('assets/img/flags/ru.png')}}" alt="Russian" width="20" class="align-middle me-1" />
                        <span class="align-middle">Russian</span>
                    </a>
                    <a class="dropdown-item" href="#">
                        <img src="{{ asset('assets/img/flags/de.png')}}" alt="German" width="20" class="align-middle me-1" />
