    ...
    <div class="sidebar-content js-simplebar">
        <a class="sidebar-brand" href="{{ route('dashboard') }}">
					<span class="sidebar-brand-text align-middle">
						Ofixee
						<sup><small class="badge bg-warning-dark text-uppercase">Ofixee</small></sup>
					</span>
        ...
        <ul class="sidebar-nav">
            ...
            <li class="sidebar-item active">
                <a data-bs-target="#dashboards" data-bs-toggle="collapse" class="sidebar-link">
                    <i class="align-middle" data-feather="sliders"></i> <span class="align-middle">{{ __('Company Actions') }}</span>
                </a>
                <ul id="dashboards" class="sidebar-dropdown list-unstyled collapse show" data-bs-parent="#sidebar">
                    <li class="sidebar-item active"><a class="sidebar-link" href="index.html">Create New Company</a></li>
                    <li class="sidebar-item"><a class="sidebar-link" href="dashboard-ecommerce.html">Companies <span
            ...
            <li class="sidebar-item">
                <a data-bs-target="#ui" data-bs-toggle="collapse" class="sidebar-link collapsed">
                    <i class="align-middle" data-feather="briefcase"></i> <span class="align-middle"></span>
                </a>
                <ul id="ui" class="sidebar-dropdown list-unstyled collapse " data-bs-parent="#sidebar">
                    <li class="sidebar-item"><a class="sidebar-link" href="#">{{ __('Create New') }}</a></li>
                    <li class="sidebar-item"><a class="sidebar-link" href="#">{{ __('List') }}</a></li>
                    <li class="sidebar-item"><a class="sidebar-link" href="#">{{ __('Categories Action') }}</a></li>
                </ul>
            </li>
            <li class="sidebar-item">
